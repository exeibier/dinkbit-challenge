    ...
    <div className={styles.contact_container}>
      <div className='container'>
          ...
          <form>
            ...
            <div className='form-row'>
              <div className='form-group col-lg-6'>
                ...
                <input type='tel' className='form-control' id='inputTel' placeholder='Ingresa tu número teléfonico' />
              </div>
              <div class='form-group col-md-6'>
            ...
            <div class='form-group'>
              ...
              <textarea class='form-control' id='exampleFormControlTextarea1' rows='4' placeholder='Cuentanos de tu proyecto o coméntanos tus dudas' />
            </div>
            <div className={styles.captcha_box}>
              <div className='g-recaptcha' data-sitekey='6LfZtdMZAAAAAEa7xOyYnAPhgVSPjssOaFHCTQbg' />
            </div>
        ...
        <div className={styles.terms}>
          <p>Al dar click en el botón enviar aceptas nuestra <a href='#'>Política de privacidad</a></p>
        </div>
      </div>
    </div>
  )
